			...
			<div class="card-body">
				...
				<form action="{{ route('category.store') }}" method="post">
					...
					<div class="form-group">
						...
						<textarea name="description" id="description" name="description" class="form-control @error('description') is-invalid @enderror" value="{{ old('description') }}" rows="5" required></textarea>
